...
class AppVersionController extends Controller
{
    ...
    {
        $appVersionFilterData = AppVersionRequest::createFrom($request)->toFilterData();
        $appVersions = $this->appVersionService->getPaginated($appVersionFilterData);
    ...
    /**
     * Get the latest app version. This is the only public endpoint.
     *
     * @param GenericRequest $request
     *
     * @return JsonResponse|JsonResource
