...
// All business rules live here. Failure is a thrown BadRequestException, which
// the handler renders as {"success": false, "message": "..."} at HTTP 400 — the
// controller never branches on a result.
class AppVersionService
{
    ...
    public function update(AppVersionData $appVersionData): ?AppVersion
    {
        ...
        return $this->appVersionRepository->save($appVersionData, $appVersion);
    }
