<!-- GENERATED from plugins/himoa/templates/validation-report.md by tests/validate-adapter-projection.mjs (himoa 3.5.0). DO NOT EDIT. Edit the canonical source and run: node tests/validate-adapter-projection.mjs --write -->
...
`@HIMOA_HOME@/standards/evidence.md` §7. A result that predates any edit
...
`@HIMOA_HOME@/standards/evidence.md` §5 already names what that
destroys.
