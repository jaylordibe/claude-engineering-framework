<!-- GENERATED from plugins/himoa/templates/contract-change.md by tests/validate-adapter-projection.mjs (himoa 3.2.0). DO NOT EDIT. Edit the canonical source and run: node tests/validate-adapter-projection.mjs --write -->
