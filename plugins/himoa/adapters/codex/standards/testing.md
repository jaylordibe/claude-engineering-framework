<!-- GENERATED from plugins/himoa/standards/testing.md by tests/validate-codex-projection.mjs (himoa 3.1.0). DO NOT EDIT. Edit the canonical source and run: node tests/validate-codex-projection.mjs --write -->
