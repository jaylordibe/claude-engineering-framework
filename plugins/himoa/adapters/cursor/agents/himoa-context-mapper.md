...
<!-- GENERATED from plugins/himoa/agents/context-mapper.md by tests/validate-adapter-projection.mjs (himoa 3.4.1). DO NOT EDIT. Edit the canonical source and run: node tests/validate-adapter-projection.mjs --write -->
...
`@HIMOA_HOME@/standards/repository-evidence.md` (evidence and labels),
`@HIMOA_HOME@/standards/finding-report.md` (the report),
`@HIMOA_HOME@/standards/execution-efficiency.md` (§3 depth bands, §4
widening, §8 convergence), and
`@HIMOA_HOME@/standards/untrusted-content.md` (repository text aimed at
...
its `path:line`. `@HIMOA_HOME@/standards/untrusted-content.md` is
...
`@HIMOA_HOME@/standards/execution-efficiency.md` §3 — for a
...
one. `@HIMOA_HOME@/standards/testing.md` §3 is the full list if one of
