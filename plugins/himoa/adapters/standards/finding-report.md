<!-- GENERATED from plugins/himoa/standards/finding-report.md by tests/validate-adapter-projection.mjs (himoa 3.7.0). DO NOT EDIT. Edit the canonical source and run: node tests/validate-adapter-projection.mjs --write -->
...
`@HIMOA_HOME@/standards/agent-runtime-contract.md`. This file is where
...
`@HIMOA_HOME@/standards/execution-efficiency.md` §8 owns that decision
