<!-- himoa:bootstrap 3.6.0 — GENERATED from plugins/himoa/scripts/session-charter.sh by tests/validate-adapter-projection.mjs. DO NOT EDIT this block; edit the charter and run --write. -->
...
_Himoa 3.6.0 — methodology only. The sections below are authoritative for what this system is._
