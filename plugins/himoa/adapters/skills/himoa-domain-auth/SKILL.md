...
<!-- GENERATED from plugins/himoa/skills/domain-auth/SKILL.md by tests/validate-adapter-projection.mjs (himoa 3.6.0). DO NOT EDIT. Edit the canonical source and run: node tests/validate-adapter-projection.mjs --write -->
